...
{
    internal class TestWhiteDefender : E2eBossFightTest
    {
        protected override string BossScene => "GG_White_Defender";
        ...
        protected override IEnumerator BossFightScript()
        {
            ...
            ExpectNoLogInParallel("Boss entering state Air Dive Antic", _lastAttackDuration);
